...
function Update-Package {
    ...
    function get_checksum()
    {
        function invoke_installer() {
            ...
            if ($env:TrustPackageChecksums -and $global:Latest.ContainsKey('Checksum32') -and $global:Latest.ContainsKey('Checksum64')) { "Automatic checksum validation is disabled"; return }
